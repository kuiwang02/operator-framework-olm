...
var _ = g.Describe("[sig-operator][Jira:OLM] OLMv0 optional should", func() {
	...
	g.It("PolarionID:68679-[OTP][Skipped:Disconnected]catalogsource with invalid name is created", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 73201
	g.It("PolarionID:73201-[OTP]-[Skipped:Disconnected]73201-catalog pods do not recover from node failure [Disruptive][Serial]", func() {
	...
	// Polarion ID: 72192
	g.It("PolarionID:72192-[OTP]-is not correctly refreshing operator catalogs due to IfNotPresent imagePullPolicy", g.Label("LEVEL0"), func() {
	...
	// Polarion ID: 72013
	g.It("PolarionID:72013-[OTP]-Creating an OperatorGroup with Name cluster breaks the whole cluster", g.Label("LEVEL0"), func() {
	...
	// Polarion ID: 53771
	g.It("PolarionID:53771-[OTP]-[Skipped:Disconnected]53771-The certificate relating to operator-lifecycle-manager-packageserver isn't rotated after expired [Slow][Disruptive]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 68681
	g.It("PolarionID:68681-[OTP]-[Skipped:Disconnected]68681-pods with no controller true ownerReferences", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 68679
	g.It("PolarionID:68679-[OTP]-[Skipped:Disconnected]68679-catalogsource with invalid name is created", g.Label("NonHyperShiftHOST"), func() {
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 59413
	g.It("PolarionID:59413-[OTP]-[Skipped:Disconnected]59413-Default CatalogSource aren't created in restricted mode [Serial]", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipIfDisableDefaultCatalogsource(oc)
		defaultCatalogSources := []string{"certified-operators", "community-operators", "redhat-marketplace", "redhat-operators"}
	...
	// Polarion ID: 59416
	g.It("PolarionID:59416-[OTP]-[Skipped:Disconnected]59416-Revert Catalog PSA decisions for 4.12 [Serial]", g.Label("NonHyperShiftHOST"), func() {
	...
	// Polarion ID: 53758
	g.It("PolarionID:53758-[OTP]-[Skipped:Disconnected]53758-failed to recreate SA for the CatalogSource that without poll Interval", func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 25966
	g.It("PolarionID:25966-[OTP]-offline mirroring support [IgnoreObsoleteTests]", func() {
		...
		g.Skip("This test is obsolete and has been skipped")
	})

	// Polarion ID: 46964
	g.It("PolarionID:46964-[OTP]-[Skipped:Disconnected]46964-Disable Copied CSVs Toggle [Serial]", func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 43101
	g.It("PolarionID:43101-[OTP]-[Skipped:Disconnected]43101-OLM blocks minor OpenShift upgrades when incompatible optional operators are installed", func() {
		architecture.SkipNonAmd64SingleArch(oc)
	...
	// Polarion ID: 37826
	g.It("PolarionID:37826-[OTP]-[Skipped:Disconnected]37826-use an PullSecret for the private Catalog Source image [Serial][IgnoreObsoleteTests]", func() {
		g.Skip("This test is obsolete and has been skipped")
	})
	...
	// Polarion ID: 37710
	g.It("PolarionID:37710-[OTP]-[Skipped:Disconnected]37710-supports the Upgradeable Supported Condition", func() {
		g.By("1) Install the OperatorGroup in a random project")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
	...
	// Polarion ID: 33450
	g.It("PolarionID:33450-[OTP]-[Skipped:Disconnected]33450-Operator upgrades can delete existing CSV before completion", g.Label("NonHyperShiftHOST"), func() {
		architecture.SkipNonAmd64SingleArch(oc)
	...
	// Polarion ID: 37260
	g.It("PolarionID:37260-[OTP]-[Skipped:Disconnected]37260-should allow to create the default CatalogSource [Disruptive]", g.Label("NonHyperShiftHOST"), func() {
		exutil.SkipBaselineCaps(oc, "None")
		exutil.SkipIfDisableDefaultCatalogsource(oc)
	...
	// Polarion ID: 33902
	g.It("PolarionID:33902-[OTP]-[Skipped:Disconnected]33902-Catalog Weighting", func() {
		architecture.SkipNonAmd64SingleArch(oc)
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		csImageTemplate := filepath.Join(buildPruningBaseDir, "catalogsource-image.yaml")
		ogSingleTemplate := filepath.Join(buildPruningBaseDir, "operatorgroup.yaml")
	...
	// Polarion ID: 22070
	g.It("PolarionID:22070-[OTP]-[Skipped:Disconnected]22070-support grpc sourcetype [Serial]", g.Label("LEVEL0"), func() {
		buildPruningBaseDir := exutil.FixturePath("testdata", "olm")
		dr := make(olmv0util.DescriberResrouce)
		itName := g.CurrentSpecReport().FullText()
		dr.AddIr(itName)
